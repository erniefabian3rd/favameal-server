# Generated by Django 3.1.3 on 2023-05-11 16:09
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('favorites', models.ManyToManyField(related_name='meals', through='favamealapi.FavoriteMeal', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Restaurant',
            fields=[
                ...
                ('favorites', models.ManyToManyField(related_name='restaurants', through='favamealapi.FavoriteRestaurant', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='MealRating',
            fields=[
                ...
                ('meal', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='mealrating_meal', to='favamealapi.meal')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='mealrating_user', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.AddField(
            model_name='meal',
            name='ratings',
            field=models.ManyToManyField(related_name='meal_ratings', through='favamealapi.MealRating', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddField(
            model_name='meal',
            name='restaurant',
